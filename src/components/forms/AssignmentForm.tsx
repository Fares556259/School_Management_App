  ...
  return (
    <form className="flex flex-col gap-6 p-6 max-h-[90vh] overflow-y-auto" onSubmit={onSubmit}>
      <div>
        ...
        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Assign homework and academic tasks to your students</p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs text-slate-400 font-bold uppercase tracking-wider">Task Instructions / Description</label>
          <textarea
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs text-gray-800 font-bold">Attachments (PDF or Image)</label>
          <input
            type="file"
            id="assignment-file"
            className="hidden"
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-2 p-6 border-2 border-dashed border-slate-200 rounded-2xl hover:border-indigo-400 hover:bg-indigo-50 transition-all group disabled:opacity-50"
          >
