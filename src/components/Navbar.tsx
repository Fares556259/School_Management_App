  ...
  return (
    <div className='flex items-center justify-between px-6 py-4 bg-[#F5F6F8]/80 backdrop-blur-md sticky top-0 z-50 border-b border-transparent transition-all'>
      ...
      <div className="hidden md:flex items-center flex-1">
        <h1 className="text-[24px] font-semibold text-[#181d26] tracking-tight">
      ...
      <div className='flex items-center gap-3 justify-end flex-1'>
        {/* COMMAND BAR */}
        <div className='hidden md:flex items-center gap-3 text-[13px] rounded-full bg-[#e5e7eb]/40 hover:bg-[#e5e7eb]/60 border border-transparent px-3 py-1.5 transition-all group w-[220px] cursor-pointer'>
          <Search size={15} className="text-[#9297a0] group-hover:text-[#41454d] transition-colors" />
          <span className="text-[#9297a0] font-medium group-hover:text-[#41454d] transition-colors flex-1">{(t.navbar as any)?.search || "Search"}</span>
        </div>
