...
export async function GET(request: NextRequest) {
  ...
  if (!digits) {
    return new NextResponse("Numéro de téléphone manquant", { status: 400 });
  }

  // Format international number (default to Tunisia +216 for 8-digit numbers)
...
<body>
  <div class="card">
    ...
    <p>Ouverture de votre application Téléphone avec le numéro prérempli...</p>
