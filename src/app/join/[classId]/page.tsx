              ...
              <div className="text-center space-y-8 py-8 animate-in zoom-in duration-500">
                ...
                <div className="p-5 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl border border-blue-100 text-left" dir={isRtl ? "rtl" : "ltr"}>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-3 justify-center">
                    <a href={process.env.NEXT_PUBLIC_APK_DOWNLOAD_URL || "#"} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 text-white px-6 py-3.5 rounded-2xl flex items-center justify-center gap-3 transition-transform hover:scale-105">
