    ...
    >
      ...
      <td className="hidden md:table-cell px-4 py-4">
        <div className="flex flex-col">
          ...
          <span className="text-[10px] text-slate-400 font-mono italic">{item.performedBy}</span>
        </div>
      </td>
      ...
      <td className="p-4 italic text-slate-600 max-w-xs truncate" title={item.description}>{item.description}</td>
