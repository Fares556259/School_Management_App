...
export default function StudentAttendanceTab({
  ...
  const formatDate = (d: Date | string) => {
    try {
      return new Date(d).toLocaleDateString(locale === "ar" ? "ar-TN" : locale === "en" ? "en-US" : "fr-FR", {
        weekday: "short",
        day: "numeric",
        month: "short",
        year: "numeric",
    ...
    <div className="flex flex-col gap-6 w-full">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold text-slate-800">
              {t.studentProfile.attendance.headerTitle}
            </h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">
            {t.studentProfile.attendance.headerSubtitle}
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
              {t.studentProfile.attendance.presenceCard}
            </span>
          ...
          <div className="mt-2">
            ...
            <span className="text-xs text-slate-400 ml-1 font-medium">
              {t.studentProfile.attendance.outOfSessions.replace("{total}", String(stats.total))}
            </span>
            <p className="text-[10px] text-slate-400 mt-0.5">
              {t.studentProfile.attendance.attendedSessions}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
              {t.studentProfile.attendance.unexcusedCard}
            </span>
          ...
          <div className="mt-2">
            ...
            <span className="text-xs text-slate-400 ml-1 font-medium">
              {t.studentProfile.attendance.missedCount}
            </span>
            <p className="text-[10px] text-slate-400 mt-0.5">
              {t.studentProfile.attendance.noReasonGiven}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
              {t.studentProfile.attendance.excusedCard}
            </span>
          ...
          <div className="mt-2">
            ...
            <span className="text-xs text-slate-400 ml-1 font-medium">
              {t.studentProfile.attendance.sessionsCount}
            </span>
            <p className="text-[10px] text-slate-400 mt-0.5">
              {t.studentProfile.attendance.withMedicalProof}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
              {t.studentProfile.attendance.latesCard}
            </span>
          ...
          <div className="mt-2">
            ...
            <span className="text-xs text-slate-400 ml-1 font-medium">
              {t.studentProfile.attendance.recordedCount}
            </span>
            <p className="text-[10px] text-slate-400 mt-0.5">
              {t.studentProfile.attendance.lateArrivals}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1" role="tablist">
        ...
        >
          {t.studentProfile.attendance.filterAll.replace("{count}", String(attendances.length))}
        </button>
        ...
        >
          ...
          <span>{t.studentProfile.attendance.filterUnexcused.replace("{count}", String(stats.unexcused))}</span>
        </button>
        ...
        >
          ...
          <span>{t.studentProfile.attendance.filterExcused.replace("{count}", String(stats.excused))}</span>
        </button>
        ...
        >
          ...
          <span>{t.studentProfile.attendance.filterLate.replace("{count}", String(stats.late))}</span>
        </button>
        ...
        >
          ...
          <span>{t.studentProfile.attendance.filterPresent.replace("{count}", String(stats.present))}</span>
        </button>
      </div>
        ...
        {filteredList.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-600">
              <thead className="bg-slate-50 border-b border-slate-100 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                <tr>
                  <th className="py-3 px-4">{t.studentProfile.attendance.colDate}</th>
                  <th className="py-3 px-4">{t.studentProfile.attendance.colSessionSubject}</th>
                  <th className="py-3 px-4">{t.studentProfile.attendance.colStatus}</th>
                  <th className="py-3 px-4">{t.studentProfile.attendance.colJustification}</th>
                  {isAdmin && <th className="py-3 px-4 text-right">{t.studentProfile.attendance.colAction}</th>}
                </tr>
              </thead>
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">
                        {record.status === "PRESENT" && (
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200">
                            ...
                            {t.studentProfile.attendance.statusPresent}
                          </span>
                        )}
                        {record.status === "LATE" && (
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-amber-50 text-amber-700 border border-amber-200">
                            <Clock size={11} />
                            {t.studentProfile.attendance.statusLate}
                          </span>
                        )}
                        {record.status === "ABSENT" && (
                          <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold ${
                            ...
                            <XCircle size={11} />
                            {t.studentProfile.attendance.statusAbsent}
                          </span>
                        )}
                      </td>
                          ...
                          isExcused ? (
                            <div className="flex flex-col">
                              <span className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-700">
                                <Check size={12} />
                                {t.studentProfile.attendance.statusExcused}
                              </span>
                            ...
                            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-rose-600">
                              <X size={12} />
                              {t.studentProfile.attendance.statusUnexcused}
                            </span>
                          )
                        ) : record.note ? (
                      ...
                      {isAdmin && (
                        <td className="py-3 px-4 text-right whitespace-nowrap">
                          {record.status === "ABSENT" && (
                            ...
                            >
                              {isExcused ? t.studentProfile.attendance.btnModify : t.studentProfile.attendance.btnJustify}
                            </button>
                          )}
                        </td>
                      )}
          ...
          <div className="p-12 text-center flex flex-col items-center justify-center">
            ...
            <h3 className="text-sm font-bold text-slate-800">
              {t.studentProfile.attendance.emptyAttendanceTitle}
            </h3>
            <p className="text-xs text-slate-400 mt-1 max-w-sm">
              {t.studentProfile.attendance.emptyAttendanceDesc}
            </p>
          </div>
        )}
      </div>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-100">
            <h3 className="text-base font-bold text-slate-800 mb-1">
              {t.studentProfile.attendance.manageModalTitle}
            </h3>
            <p className="text-xs text-slate-500 mb-4">
              {t.studentProfile.attendance.modalDateSession
                .replace("{date}", formatDate(selectedAttendance.date))
                .replace("{lesson}", selectedAttendance.lesson?.subject?.name?.split("|")[0] || "Séance")}
            </p>

            <div className="flex flex-col gap-3">
              <div>
                <label className="text-xs font-bold text-slate-700 block mb-1">
                  {t.studentProfile.attendance.modalReasonLabel}
                </label>
                <textarea
                  value={justificationInput}
                  onChange={(e) => setJustificationInput(e.target.value)}
                  placeholder={t.studentProfile.attendance.modalReasonPlaceholder}
                  rows={3}
              ...
              <div className="flex items-center justify-end gap-2 mt-3 pt-3 border-t border-slate-100">
                ...
                >
                  {t.studentProfile.attendance.btnCancel}
                </button>
                ...
                >
                  {t.studentProfile.attendance.btnMarkUnexcused}
                </button>
                ...
                >
                  {t.studentProfile.attendance.btnApproveJustification}
                </button>
              </div>
            </div>
          </div>
