  ...
  return (
    <div className="flex-1 p-4 lg:p-6 flex flex-col gap-6 max-w-[1600px] mx-auto w-full animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-100 p-6 shadow-sm h-96" />
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm h-48" />
          <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm h-40" />
        </div>
      </div>
    </div>
  );
