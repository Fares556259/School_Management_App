...
export default function AnnouncementFilters({ 
  ...
  return (
    <div className="flex flex-wrap items-center bg-[#f8fafc] border border-[#dddddd] rounded-[8px] px-3 py-2 gap-4 w-fit">
      {/* Search */}
      <div className="flex items-center gap-2 px-2 border-r border-[#dddddd] pr-6 relative">
      ...
      <div className="flex items-center gap-3 px-2">
        <span className="text-[13px] font-medium text-[#41454d]">Target</span>
        <div className="relative inline-flex items-center">
          ...
          >
            ...
            {classes.map(c => <option key={c.id} value={c.id.toString()}>Class {c.name}</option>)}
          </select>
